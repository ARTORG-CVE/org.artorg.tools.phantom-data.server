...
public class PropertyFieldController extends
		ControllerSpec<PropertyField, UUID, IpropertyFieldService<PropertyField>> {
	
	@GetMapping("get-by-name/{name}")
	public ResponseEntity<PropertyField>
			getByPropertyField(@PathVariable("name") String name) {
