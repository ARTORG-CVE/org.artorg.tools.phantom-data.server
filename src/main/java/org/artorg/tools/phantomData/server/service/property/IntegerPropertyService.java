...
@Service
public class IntegerPropertyService implements IintegerPropertyService<IntegerProperty, Integer> {
	
	@Autowired
	private IntegerPropertyRepository repository;
	
	@Override
	public CrudRepository<IntegerProperty, Integer> getRepository() {
		return repository;
	}
